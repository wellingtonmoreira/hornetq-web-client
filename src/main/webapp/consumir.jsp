...
<body style="text-align:center;">
   <form method="GET" action="consumePayLoadServlet">
    ...
    <span>Payload:</span><textarea readonly="true"><%= request.getAttribute("payload") == null ? "" : request.getAttribute("payload") %></textarea></br>
</body>
</html>